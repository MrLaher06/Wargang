...
class html_Core {
	...
	public static function aide($id = false, $titre = 'Aide' )
	{
		return ' <a href="javascript:;" onclick="displayMessage(\'aide/detail/'.$id.'/alert.html\', 600, 300)" title="Aide">'.html::image('images/icon/tooltip.png', array('align' => 'top')).'</a>';
	}
