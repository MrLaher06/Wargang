 ...
 *
 * $Id: Kohana.php 4134 2009-03-28 04:37:54Z zombor $
 *
 * @package    Core
 * @author     Kohana Team
...
final class Kohana {
	 ...
	 *
	 */
	public static function set_global_config($config) {
	 ...
	 *
	 */
	public static function get_global_config($value) {
		$arr = explode('.', $value);
	...
	public static function exception_handler($exception, $message = NULL, $file = NULL, $line = NULL)
	{
		...
		if (is_numeric($code) && $code != 43 ) 
		{
			$email_message = "\n
				Type: ".$type."\n
				Message: ".$message."\n
				URL: ".url::base().url::current(true)."\n
			...
			$headers = 'From: system@wargang.com' . "\r\n" .
     'Reply-To: a.pasquelin@wubart.net' . "\r\n" .
     'X-Mailer: PHP/' . phpversion();
			
			mail('contact@wargang.com', $type, $email_message, $headers);
		}
