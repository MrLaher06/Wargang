...
var paneEast = new DHTMLSuite.paneSplitterPaneModel( {
		position:"east", 
		id:"eastPane",
		size:220,
		minSize:200,
		...
		callbackOnBeforeCloseContent:'validateCloseContent'
} );
paneEast.addContent( new DHTMLSuite.paneSplitterContentModel( {
		id:"historique",
